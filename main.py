...
def create_all_car_with_all_license_plates_dict() -> list[Car]:
    d = {}
...
def get_car_by_regno_dict(regnr:str, dict_of_cars:dict[str,Car]) -> Car|None:
...
def main():
    ...
    t_start = default_timer()
    cars_dict = create_all_car_with_all_license_plates_dict()
    t_end = default_timer()
    ...
    while True:
        ...
        t_start = default_timer()
        car = get_car_by_regno_dict(regnr, cars_dict)
        t_end = default_timer()
